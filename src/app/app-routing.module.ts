...
const routes: Routes = [
  ...
  //coordinateur routes
  {
    ...
    children: [
      ...
      {path: "jurys", component: ListJuryComponent},
  ...
  //encadrant routes
  {
    path: "encadrant", component: EncadreurComponent, canActivate: [AuthGuard], data: {
    ...
    children: [
      ...
      {path: "edit", component: EditProfileComponent},
	  {path: "etudiants", component: ListEtudiantComponent},
      {path: '', redirectTo: 'encadrant/profile', pathMatch: 'full'},
      {path: '**', redirectTo: 'encadrant/profile'}
    ]
  },
  //admin routes
  {
  ...
  //jury routes
  {
    ...
    children: [
      {path: "profile", component: ListStagesComponent},
      {path: "", redirectTo: "jury/profile", pathMatch: 'full'},
      {path: "edit", component: EditProfileComponent},
      {path: "**", redirectTo: 'jury/profile'}
    ]
  },
  //forum
  {
  ...
  {path: "mot-de-pass-oublier", component: ForgetPwdComponent},
  //main page
  {
