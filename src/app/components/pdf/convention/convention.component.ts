   ...
   convention(){
    return  {
      content:[
          ...
          {text:'Étudiant(e) régulièrement inscrit(e) dans l’établissement pour l’année universitaire 2019/2020 et dont la carte d’étudiant porte le numéro du CNE suivant :'+this.conventionStage.etudiantCne[0],fontSize:11.1},
